...
{
    public partial class AdminInsertEvent : System.Web.UI.Page
    {
        ...
        protected void insertNews()
        {
            ...
            if (rdioTypeEvent.Checked)

                myNews.newsPriority = "خبر-رویداد";
            else
                if (rdioTypeAmozeshi.Checked)
                    myNews.newsPriority = "آموزشی-پژوهشی";
            ...
            if (rdioTypeEvent.Checked)
                myNews.newsBranchName = "خبر-رویداد";
            else
                if (rdioTypeAmozeshi.Checked)
                    myNews.newsBranchName = "آموزشی-پژوهشی";


            if (myNews.insertNews("TableNews") == null)
                lblMessage.Text = "خبر / رویداد ارسال شد.";
            else
                lblMessage.Text = "خبر / رویداد با عنوان ::" + txtnewsTitle.Text + ":: قبلا ذخیره شده است.";
