...
CodeBehind="AdminShowUsers.aspx.cs" Inherits="PresentationLayer.Admin.AdminShowUsers" %>
...
<h1 class="content-box-title">
 نمایش - آرشیو - حذف - ویرایش مطالب و مقالات   </h1>
<p>
<br />
...
<asp:Button ID="btnArchieve" runat="server" CausesValidation="False" 
          ...
          DataKeyNames="UserStudentRowID" AllowPaging="True" onpageindexchanging="GridView1_PageIndexChanging" 
                                PageSize="20" >
    ...
    <ItemStyle Wrap="False" HorizontalAlign="Right" />
                                ...
                                <asp:BoundField DataField="UserStudentUnivesityName" HeaderText="استان" />
                                <asp:BoundField DataField="UserStudentEducationBranchName" HeaderText="شهر" />

                                <asp:BoundField DataField="UserStudentSpecialty" HeaderText="نوع عضویت" />
                                ...
                                <asp:ButtonField CommandName="goToEdit" Text="مشخصات">
