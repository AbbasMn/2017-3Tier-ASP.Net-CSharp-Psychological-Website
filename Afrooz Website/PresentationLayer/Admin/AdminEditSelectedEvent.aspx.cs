...
{
    public partial class AdminEditSelectedEvent : System.Web.UI.Page
    {
        ...
        protected void showSelectedEvent()
        {
            DataTable dt = new DataTable();
            News myNews = new News();
           ...
           string s3 = dt.Rows[0]["newsBranchName"].ToString();

            if (s3 == "خبر-رويداد")
                rdioTypeEvent.Checked = true;

           if (s3 == "آموزشي-پژوهشي")
               rdioTypeAmozeshi.Checked = true;
