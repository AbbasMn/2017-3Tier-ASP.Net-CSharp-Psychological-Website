...
CodeBehind="ShowAllMabhas.aspx.cs" Inherits="PresentationLayer.User.ShowAllMabhas" %>
...
<div id="Div2" class="tab-news-item" runat="server" >
 ...
 <a>
 <img id="Img1" src="../NewsImages/<%#Eval("newsPictureName")%>" width="170" height="80" >    
  </a>
                                <h2 class="tab-news-item-title">
                                                                    
                                	<asp:LinkButton ID="LinkButtonTitle"  runat="server" Text=<%#Eval("newsTitle")%> CommandName="goToShowDetails" ToolTip=<%#Eval("newsTitle")%>></asp:LinkButton>
