...
CodeBehind="AdminAtieNooEditNews.aspx.cs" Inherits="PresentationLayer.Admin.AdminAtieNooEditNews" %>
...
<h1 class="content-box-title">
 نمایش - حذف - پیامهای کلینیک آتیه نو   </h1>
<p>


<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/AdminAtieNoo.aspx" class="content-box-PassageMy" ForeColor="#00b1b2">ارسال پیام جدید برای کلینیک آتیه نو</asp:HyperLink>
<br />
