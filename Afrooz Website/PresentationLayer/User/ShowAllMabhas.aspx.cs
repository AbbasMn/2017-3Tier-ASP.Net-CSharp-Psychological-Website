...
{
    public partial class ShowAllMabhas : System.Web.UI.Page
    {
        ...
        private void showPasseges(string showType)
        {
            ...
            try
            {
                ...
                if (showType == "All")
                {
                    ...
                    lblSortTpe.Text ="مبحث "+Session["AllMabhas"].ToString() + " - "+ "نمایش مطالب و مقاله ها";
                }
                else
                    if (showType == "Matlab")
                    {
                        ...
                        lblSortTpe.Text ="مبحث "+Session["AllMabhas"].ToString() + " - " + "نمایش مطالب ";
                    ...
                    if (showType == "Magale")
                    {
                        ...
                        lblSortTpe.Text = "مبحث "+ Session["AllMabhas"].ToString() + " - " + "نمایش مقاله ها";
                    }
                    else
                    if (showType == "Dastebandi")
                    {
                        ...
                        lblSortTpe.Text = "مبحث "+ Session["AllMabhas"].ToString() + " - " + "نمایش مطالب و مقاله ها بر اساس مبحث";
                    }
                    else
                    ...
                    if (showType == "Date")
                    {
                        ...
                        lblSortTpe.Text = "مبحث "+ Session["AllMabhas"].ToString() + " - " + "نمایش مطالب و مقاله ها بر اساس تاریخ";
                    }
                    else
                    if (showType == "Bazdid")
                    {
                        ...
                        lblSortTpe.Text = "مبحث "+ Session["AllMabhas"].ToString() + " - " + "نمایش مطالب و مقاله ها بر اساس تعداد بازدید";
                    }
                    else
                    if (showType == "Mozo")
                    {
                        ...
                        lblSortTpe.Text = "مبحث "+ Session["AllMabhas"].ToString() + " - " + "نمایش مطالب و مقاله ها بر اساس موضوع";
                    }
                    else
                    if (showType == "Event")
                    {
                        ...
                        lblSortTpe.Text = "مبحث "+ Session["AllMabhas"].ToString() + " - " + "نمایش اخبار رویدادها";
                    }
                     else
                     if (showType == "Edu")
                    {
                        ...
                        lblSortTpe.Text = "مبحث "+ Session["AllMabhas"].ToString() + " - " + "نمایش اخبار آموزشی - پژوهشی";
                    }
                ...
                {
                    WhereCommand = WhereCommand + "newsType='" + Session["AllMabhas"].ToString()+"'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["AllMabhas"].ToString() != "مشاوره ازدواج" &
                ...
                Session["AllMabhas"].ToString() != "مهارتهاي زندگي")
