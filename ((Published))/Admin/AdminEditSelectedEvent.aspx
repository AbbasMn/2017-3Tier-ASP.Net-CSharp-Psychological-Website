<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/WebsiteLayout/MainMaster.Master"
  CodeBehind="AdminEditSelectedEvent.aspx.cs" Inherits="PresentationLayer.Admin.AdminEditSelectedEvent" %>
...
ویرایش رویداد / خبر روانشناسی </h1>
<p>
...
<table width="100%" align="right" class="register-form" >
        ...
        Font-Size="15px" Font-Names="Times New Roman" Font-Bold="True" 
        NavigateUrl="~/WebsiteLayout/Pic/Icons/admin.png"  style="float:left;"></asp:HyperLink>
                ...
                ToolTip="فايل ضميمه را انتخاب نماييد" EnableTheming="True" TabIndex="11" Cssclass="text-field short-text-input"
                    ...
                    <asp:Button ID="btnSave" runat="server" style="margin-right: 0px; margin-bottom: 16px;" Text="ویرایش" 
